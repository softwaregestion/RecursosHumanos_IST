    ...
    public class UserCreateDefaultPassword : ControllerBase
    {
        ...
        public IActionResult Get(string id)
        {
            ...
            this.Email.SendMail(users.Email, "Nueva cuenta Registrada", string.Format(@"Sr/a, {0}
                                                                            <br/><br/> 
                                                                            Se ha registrado la creación de su cuenta '{0}' en el sistema IST,  para continuar haga click en el siguiente <a href='" + IST.Api.AppConfig.UrlWeb + @"/recovery/recoverynewpassword/{2}?recoveryid={1}'>enlace</a> para asignar contraseña
                                                                            <br/><br/> 
                                                                            <br/><br/> 
