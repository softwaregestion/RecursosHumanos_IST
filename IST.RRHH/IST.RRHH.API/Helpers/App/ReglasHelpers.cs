...
namespace IST.RRHH.API.Helpers.App
{
    public class ReglasHelpers
    {
        ...
        public static string GetClaimValue(List<Domain.Query.AspNetUserClaims.Index.GetAllByUserId.Result> claim, string claimType)
        {
        ...
        public static string GetClaimValue(List<Domain.Query.ClientClaims.Index.GetAllByClientId.Result> claim, string claimType)
        {
