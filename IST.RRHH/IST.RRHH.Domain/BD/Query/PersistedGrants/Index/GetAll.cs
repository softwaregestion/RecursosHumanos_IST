...
namespace IST.RRHH.Domain.Query.PersistedGrants.Index
{   
	...
	public class GetAll
    {
        ...
        public class Handler : IQueryHandler<Query, List<Result>>
        {
            ...
            public List<Result> Handle(Query query)
            {
                ...
                var queriedItem = context.PersistedGrants.ToList();

				var orderedResults = queriedItem.Select(c=> new Result { Key = c.Key , 
											   Type = c.Type , 
