...
namespace IST.RRHH.Web.Helpers
{
    public class Email
    {
        ...
        {
            //var token = ServiciosRest.GetTokenUser().Result;
            //ServiciosRest.CallPostService<Domain.EmailModel, Domain.EmailModel>(new Domain.EmailModel() { App = "Licitaciones", Asunto = asunto, Contenido = body, Nombre = para, Para = para }, "CentroNotificaciones", token);
